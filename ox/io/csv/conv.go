...
func bToFloat64(b []byte) numericRes[float64] {
...
func bToFloat32(b []byte) numericRes[float32] {
...
func bToNYearMonthDay(b []byte) dateRes {
...
func bToNMonthDayYear(b []byte) dateRes {
...
func bToNDayMonthYear(b []byte) dateRes {
...
func bToAMonthDayYearLong(b []byte) dateRes {
...
func bToAMonthDayYearShort(b []byte) dateRes {
